...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath }/flatform/developer/appinfomodifysave" method="post" enctype="multipart/form-data">
          <input  name="id" id="id" value="${appInfo.id}">

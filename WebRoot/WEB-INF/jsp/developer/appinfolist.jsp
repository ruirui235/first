...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="${pageContext.request.contextPath }/flatform/developer/appinfolist">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select name="categoryLevel1"  id="queryCategoryLevel1" class="form-control">
									<c:if test="${categoryLevel1List != null }">
									   <option value="">--请选择--</option>
									   <c:forEach var="dataDictionary" items="${categoryLevel1List}">
									   		<option <c:if test="${dataDictionary.id == categoryLevel1}">selected="selected"</c:if>
									   		value="${dataDictionary.id}">${dataDictionary.categoryName}</option>
									   </c:forEach>
									</c:if>
        						</select>
							</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select name="categoryLevel2"  id="queryCategoryLevel2" class="form-control">
									<c:if test="${categoryLevel2List != null }">
									   <option value="">--请选择--</option>
									   <c:forEach var="dataDictionary" items="${categoryLevel2List}">
									   		<option <c:if test="${dataDictionary.id == categoryLevel2}">selected="selected"</c:if>
									   		value="${dataDictionary.id}">${dataDictionary.categoryName}</option>
									   </c:forEach>
									</c:if>
        						</select>
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select name="categoryLevel3"  id="queryCategoryLevel3" class="form-control">
									<c:if test="${categoryLevel3List != null }">
									   <option value="">--请选择--</option>
									   <c:forEach var="dataDictionary" items="${categoryLevel3List}">
									   		<option <c:if test="${dataDictionary.id == categoryLevel3}">selected="selected"</c:if>
									   		value="${dataDictionary.id}">${dataDictionary.categoryName}</option>
									   </c:forEach>
									</c:if>
        						</select>
	...
	<div class="x_panel">
		<div class="x_content">
			...
			<div id="datatable-responsive_wrapper"
				...
				<div class="row">
					<div class="col-sm-12">
					<a href="${pageContext.request.contextPath}/flatform/developer/appinfoadd" class="btn btn-success btn-sm">新增APP基础信息</a>
